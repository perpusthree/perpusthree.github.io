    ...
    books.forEach(item => {
        ...
        var table = `
            <tr>
                ...
                <td>`+ item.borrowed +`</td>
                <td>
                    <a href=""><button class="btn btn-success" style="margin-bottom: 5px;"><i class="fa fa-edit"></i></button></a>
                    <a href="" onclick="return confirm('Anda yakin Buku ini akan dihapus ?');"><button class="btn btn-danger"><i class="fa fa-trash"></i></button></a>
                </td>
            </tr>
        `
        id++
